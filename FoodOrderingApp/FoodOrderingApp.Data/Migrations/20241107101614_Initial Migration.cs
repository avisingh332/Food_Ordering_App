        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegisterationTimeStamp = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RetaurantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_Menus_DishId",
                        column: x => x.DishId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReviewText = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1a0d5c4c-6b0e-4b7b-8b5e-4a3d6c5c7b8a", "1a0d5c4c-6b0e-4b7b-8b5e-4a3d6c5c7b8a", "RestaurantOwner", "RESTAURANTOWNER" },
                    { "80ee5384-80a7-4aac-b4c8-b80b7dd25ac1", "80ee5384-80a7-4aac-b4c8-b80b7dd25ac1", "Admin", "ADMIN" },
                    { "95cb1e1c-d8b6-45a2-b240-6d211c06fd00", "95cb1e1c-d8b6-45a2-b240-6d211c06fd00", "Customer", "CUSTOMER" }
                });
